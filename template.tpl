...
const configurationOptions = data;
log('data =', data);
...
const initMoesif = () => {
  ...
  const result = callInWindow('moesif.init', configurationOptions);
  log(result);
